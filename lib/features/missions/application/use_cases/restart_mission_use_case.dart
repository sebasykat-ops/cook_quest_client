...
class RestartMissionUseCase {
  RestartMissionUseCase({required MissionRepository missionRepository}) : _missionRepository = missionRepository;

  final MissionRepository _missionRepository;

  Future<MissionEntity> run(String missionId) {
    return _missionRepository.restartMission(missionId);
  }
}
